...
- _CONTEXT.json_ is the primary source of IDs, names, relationships, and other metadata for the current script request. It is generated by FileMaker and scoped to exactly the objects needed for the task.
